...
export class GetUserFeedbackByIdUseCase implements IGetUserFeedbackByIdService {
    constructor(private _feedbackRepository: IFeedbackRepository) { }

    async execute(userId: string, feedbackId: string): Promise<FeedbackResponseDTO> {
        try {
